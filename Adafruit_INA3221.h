...
/**
 * @brief Enumeration for the conversion time values in the Configuration register.
 * 
 * Represents the conversion time for both bus voltage and shunt voltage.
 */
typedef enum {
    INA3221_CONVTIME_140US    = 0b000,    ///< Conversion time: 140탎 exact
    INA3221_CONVTIME_204US    = 0b001,    ///< Conversion time: 204탎 exact
    INA3221_CONVTIME_332US    = 0b010,    ///< Conversion time: 332탎 exact
    INA3221_CONVTIME_588US    = 0b011,    ///< Conversion time: 588탎 exact
...
public:
    ...
    bool begin(uint8_t i2c_addr = INA3221_DEFAULT_ADDRESS, TwoWire *theWire = &Wire);
