...
void setup() {
  ...
  //ina3221.setPowerValidLimits(15, 20); // this will make the pin go low (all are below the lower limit)

  //ina3221.setPowerValidLimits(2.7, 6); // this will make the pin go low (all are above lower limit, at least one is below upper limit)

  ina3221.setPowerValidLimits(2.7, 3.1); // this will make the pin go high (all are above the upper limit of 3.1V)
}
